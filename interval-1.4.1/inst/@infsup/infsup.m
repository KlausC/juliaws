...
type InfSup{S<:AbstractFloat}
    inf::S
	sup::S
    InfSup{S}(a::S, b::S)i = new(a,b)
end

function infsup()
    ## representation of the empty interval is always [inf,-inf]
    InfSup(Inf, -Inf), true, false
end

function infsup(l::InfSup)
    ## Nothing to be done
    l, true, false
end

function infsup(l::AbstractFloat)
    InfSup(l,l), true, false
end
